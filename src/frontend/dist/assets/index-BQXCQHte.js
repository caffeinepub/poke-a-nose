...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `min-h-screen transition-colors duration-300 ${isDark ? "dark bg-neutral-950" : "bg-white"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-10 flex items-center justify-between px-6 py-4 backdrop-blur-sm bg-white/80 dark:bg-neutral-950/80 border-b border-neutral-100 dark:border-neutral-800", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-lg tracking-tight text-neutral-900 dark:text-white", children: "Jelle van Meerendonk" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex flex-col items-center px-4 py-12 md:py-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-3xl mx-auto mb-12 md:mb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: "/assets/poke_game.jpg",
              alt: "Poke a Nose — illustrated black and white artwork by Jelle van Meerendonk",
              className: `w-full h-auto block rounded-sm transition-all duration-300 ${isDark ? "invert" : ""}`
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-xl mx-auto space-y-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-5xl md:text-7xl font-extrabold uppercase tracking-tight text-neutral-900 dark:text-white leading-none", children: "Poke a Nose" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg md:text-xl font-semibold text-neutral-700 dark:text-neutral-200", children: "A video game by Jelle van Meerendonk" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                children: "Visit Poke A Nose"
              }
            ) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "mt-20 py-8 text-center text-xs text-neutral-400 dark:text-neutral-600 border-t border-neutral-100 dark:border-neutral-800", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "© 2026" }) })
      ]
    }
  );
}
